...
const PALETTES = [
  ...
  { // 리KR
    ...
    vars: {
      ...
      '--color-accent': '#f6b655',
      '--color-accent-hover': '#fff3b2',
      '--color-btn-primary': '#c22628',
      '--color-btn-primary-hover': '#f27127',
      '--color-btn-copy': '#3d223c',
      '--color-btn-copy-hover': '#543253',
      '--color-btn-secondary': '#241e1e',
      '--color-btn-secondary-hover': '#342828',
      '--color-btn-blue': '#1b2e3c',
      '--color-btn-blue-hover': '#2a4459',
      '--color-btn-success': '#0f5c2b',
      '--color-btn-success-hover': '#147a39',
      '--color-btn-danger': '#c33e35',
      '--color-border': '#3a2a20',
      '--color-border-slot': '#7f97ac',
      '--color-border-light': '#c4bee2',
      '--color-border-accent': '#168f43',
      '--color-field-sky': '#eef6be',
      '--color-field-sky-bg': '#f6d3ff',
      '--color-shadow': 'rgba(0, 0, 0, 0.65)',
      '--color-shadow-heavy': 'rgba(0, 0, 0, 0.85)',
