...
const PALETTES = [
  {
    ...
    vars: {
      '--color-bg-root': '#0d0f0e', '--color-bg-base': '#131a16', '--color-bg-panel-dark': '#0f1512',
      '--color-bg-surface': '#1e2820', '--color-accent': '#c8a86b', '--color-accent-hover': '#dbbf82',
      '--color-border': '#2a342c', '--color-border-slot': '#374039', '--color-border-accent': '#5a4e34',
      '--color-btn-primary': '#8b3a2a', '--color-btn-primary-hover': '#a84432',
      '--color-btn-success': '#2d5c3a', '--color-btn-success-hover': '#38724a',
      '--color-field-sky': '#4a5c4e', '--color-field-sky-bg': '#3d5040',
      '--color-btn-blue' : '#2a4a5c', '--color-btn-blue-hover': '#365a72',
      '--color-border-light': '#1a2028',
    },
  },
  {
    ...
    vars: {
      '--color-bg-root': '#0c0e10', '--color-bg-base': '#111418', '--color-bg-panel-dark': '#0d1014',
      '--color-bg-surface': '#1a2028', '--color-accent': '#7ba8c4', '--color-accent-hover': '#9bbdd6',
      '--color-border': '#222a32', '--color-border-slot': '#2e3a46', '--color-border-accent': '#3a5264',
      '--color-btn-primary': '#7c3a28', '--color-btn-primary-hover': '#964830',
      '--color-btn-success': '#2a4a5c', '--color-btn-success-hover': '#365a72',
      '--color-field-sky': '#3c5060', '--color-field-sky-bg': '#2e4050',
      '--color-btn-blue' : '#2a4a5c', '--color-btn-blue-hover': '#365a72',
      '--color-border-light': '#1a2028',
    },
  },
  {
    ...
    vars: {
      '--color-bg-root': '#100808', '--color-bg-base': '#180f0e', '--color-bg-panel-dark': '#120c0a',
      '--color-bg-surface': '#281810', '--color-accent': '#c4845a', '--color-accent-hover': '#d4986e',
      '--color-border': '#2e1810', '--color-border-slot': '#3e2818', '--color-border-accent': '#5a3820',
      '--color-btn-primary': '#7a2a1c', '--color-btn-primary-hover': '#923222',
      '--color-btn-success': '#4a2c18', '--color-btn-success-hover': '#5a3820',
      '--color-field-sky': '#4a3c2c', '--color-field-sky-bg': '#3a2c1c',
      '--color-btn-blue' : '#2a4a5c', '--color-btn-blue-hover': '#365a72',
      '--color-border-light': '#1a2028',
    },
  },
  {
    ...
    vars: {
      '--color-bg-root': '#090909', '--color-bg-base': '#111111', '--color-bg-panel-dark': '#0c0c0c',
      '--color-bg-surface': '#1c1c1c', '--color-accent': '#a09a92', '--color-accent-hover': '#b8b2aa',
      '--color-border': '#242424', '--color-border-slot': '#303030', '--color-border-accent': '#484038',
      '--color-btn-primary': '#583a38', '--color-btn-primary-hover': '#6a4844',
      '--color-btn-success': '#2e3232', '--color-btn-success-hover': '#3a3e3e',
      '--color-field-sky': '#3a3a3a', '--color-field-sky-bg': '#2e2e2e',
      '--color-btn-blue' : '#2a4a5c', '--color-btn-blue-hover': '#365a72',
      '--color-border-light': '#1a2028',
    },
  },
  {
    ...
    vars: {
      '--color-bg-root': '#080b10', '--color-bg-base': '#0b0e14', '--color-bg-panel-dark': '#080b12',
      '--color-bg-surface': '#141824', '--color-accent': '#8891b8', '--color-accent-hover': '#a0aad0',
      '--color-border': '#1c2030', '--color-border-slot': '#28303e', '--color-border-accent': '#3a4460',
      '--color-btn-primary': '#7c3a28', '--color-btn-primary-hover': '#944830',
      '--color-btn-success': '#1c2c48', '--color-btn-success-hover': '#24385c',
      '--color-field-sky': '#283850', '--color-field-sky-bg': '#1e2c40',
      '--color-btn-blue' : '#2a4a5c', '--color-btn-blue-hover': '#365a72',
      '--color-border-light': '#1a2028',
    },
  },
